...
class pruebaFutbol {
	...
	public void queSePuedanRegistrarPartidosAlTorneo(){
		...
		Miembro      jugador       = new Jugador       ("Kun", "Aguero", "Argentina", TipoDeMiembro.JUGADOR,40512642, Posicion.DEL );
		Miembro      jugador2      = new Jugador       ("Matias", "Rojas", "Argentina", TipoDeMiembro.JUGADOR,41512642, Posicion.DEL );
